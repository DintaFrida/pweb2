...
<head>
    <meta charset="UTF-8">
    <title>Data Pemeriksaan - Pink Puskesmas</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="list_periksa.php">Periksa</a></li>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="mb-4">
                ...
                <a href="form_periksa.php" class="btn btn-pink">+ Tambah Pemeriksaan</a>
            </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-ffe4e1">
                            ...
                            <td class="py-2 px-4">
                                <a href="form_periksa.php?id=<?= $row->id ?>" class="btn btn-sm btn-outline-pink">Edit</a>
                                <a href="proses_periksa.php?hapus=1&id=<?= $row->id ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus data ini?')">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
